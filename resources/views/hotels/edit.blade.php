        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/hotels/{{ $hotel->id }}">
                        {{ csrf_field() }}
                        {{ method_field('PATCH')}}
                        ...
                        <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nombre" type="text" class="form-control" name="nombre" maxlength="100" value="{{ $hotel->nombre }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="tipo">
									   ...
									   @if($hotel->tipo == 'hotel')
                                        ...
                                        @endif
                                        @if($hotel->tipo == 'posada')
                                          <option value="posada" selected>Posada</option>
                                        @else
                                          <option value="posada">Posada</option>
                                        @endif
                                        @if($hotel->tipo == 'hostal')
                                          <option value="hostal" selected>Hostal</option>
                                        @else
                                          <option value="hotel">Hostal</option>
                                        @endif
								</select>
						...
						<div class="form-group{{ $errors->has('fecha') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fecha" type="date" class="form-control" name="fecha" value="{{ $hotel->fecha }}">
        				...
        				<div class="form-group{{ $errors->has('direccion1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="direccion1" type="text" class="form-control" name="direccion1" maxlength="100" value="{{ $hotel->direccion }}">
						...
						<div class="form-group{{ $errors->has('postal') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="postal" type="number" class="form-control" name="postal" maxlength="5" value="{{ $hotel->postal }}">
                        ...
                        <input name="user_id" type="hidden" value="{{ $hotel->user_id }}">

                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> Editar Establecimiento
                                </button>
                            </div>
                        </div>
                    </form>
